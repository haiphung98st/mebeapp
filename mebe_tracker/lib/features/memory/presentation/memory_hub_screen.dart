            ...
            sliver: SliverGrid(
              ...
              delegate: SliverChildListDelegate([
                ...
                _FeatureCell(
                  emoji: '✨',
                  label: 'Story Card',
                  subtitle: 'Tạo card đẹp để share',
                  color: const Color(0xFFFFE4EF),
                  accent: AppColors.blossom,
                  isPremium: false,
                  onTap: () => context.push('/memory/story-card/editor'),
                ),
                _FeatureCell(
                  emoji: '📖',
                  label: 'Khung Baby Book',
                  subtitle: '4 layout + poster in được',
                  color: const Color(0xFFFFF0E8),
                  accent: AppColors.mauve,
                  isPremium: true,
                  onTap: () => context.push('/memory/baby-book/frame'),
                ),
              ]),
            ),
          ),
